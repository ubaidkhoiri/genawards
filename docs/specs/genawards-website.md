---
title: Event Design Kit Static Website
status: approved
---
...
- **Pure HTML5 + CSS3 + Vanilla JavaScript** â€” TANPA build step, TANPA framework, TANPA npm/node_modules.
...
â”œâ”€â”€ branding.html                 # Brand guideline (warna, font, logo usage)
â”œâ”€â”€ moodboard.html                # Moodboard visual direction
â”œâ”€â”€ assets.html                   # Katalog asset + download
â”œâ”€â”€ assets/
â”‚   â”œâ”€â”€ css/
â”‚   â”‚   â”œâ”€â”€ style.css             # Global styles
â”‚   â”‚   â””â”€â”€ tokens.css            # Design tokens (warna, spacing, font)
â”‚   â”œâ”€â”€ js/
â”‚   â”‚   â”œâ”€â”€ main.js               # Nav, theme toggle, copy-to-clipboard
â”‚   â”‚   â””â”€â”€ gallery.js            # Render asset cards dari data JSON
â”‚   â”œâ”€â”€ images/
â”‚   â”‚   â”œâ”€â”€ logos/                # Logo PNG/SVG
â”‚   â”‚   â”œâ”€â”€ banners/              # Banner event
â”‚   â”‚   â”œâ”€â”€ icons/                # Ikon SVG
â”‚   â”‚   â””â”€â”€ backgrounds/          # Background/texture
â”‚   â”œâ”€â”€ moodboard/                # Gambar referensi moodboard
â”‚   â””â”€â”€ data/
â”‚       â””â”€â”€ assets.json           # Manifest asset (nama, kategori, path, deskripsi)
â”œâ”€â”€ downloads/
â”‚   â”œâ”€â”€ png/                      # File PNG siap download
â”‚   â”œâ”€â”€ svg/                      # File SVG siap download
â”‚   â””â”€â”€ packs/                    # ZIP bundle (logo-pack.zip, dsb)
â”œâ”€â”€ .github/
â”‚   â””â”€â”€ workflows/
â”‚       â””â”€â”€ deploy.yml
â””â”€â”€ README.md
...
```css
:root {
  /* Warna â€” sesuaikan dengan brand event, contoh: */
...
## 1. index.html â€” Landing
- Hero section: judul event kit, tagline, 2 CTA ("Lihat Asset" â†’ assets.html, "Brand Guide" â†’ branding.html).
- Grid 3-4 preview kategori (Logo, Banner, Icon, Background) dengan jumlah file.
- Section "Cara Pakai" (3 langkah: pilih â†’ download â†’ pakai).
- Footer dengan link GitHub repo.

## 2. assets.html â€” Katalog Asset
- Search bar (filter by nama/tag) â€” pure JS, filter `assets.json` di client.
...
## 3. branding.html â€” Brand Guideline
...
1. **Copy-to-clipboard** untuk hex code & asset path â€” pakai `navigator.clipboard.writeText()`, tampilkan toast "Copied!".
2. **Dark/light toggle** â€” simpan preferensi di `localStorage`, apply `data-theme` di `<html>`.
3. **Download** â€” pakai `<a href="..." download>` untuk single file. Untuk bundle, sediakan ZIP di `downloads/packs/`.
4. **Search & filter** â€” client-side, filter array dari `assets.json`, re-render grid.
5. **Keyboard accessible** â€” semua tombol/interaktif harus bisa di-tab, ada `:focus-visible` style.
...
4. **Deploy**: push ke `main` â†’ otomatis live dalam ~1 menit.

# CONSTRAINT & LARANGAN

- âŒ JANGAN pakai React, Vue, Svelte, Tailwind CDN, Bootstrap, jQuery.
- âŒ JANGAN pakai build step (Vite, Webpack, Parcel).
- âŒ JANGAN pakai backend/API eksternal.
- âŒ JANGAN hardcode warna â€” selalu pakai CSS variable.
- âŒ JANGAN pakai inline style kecuali untuk dynamic value dari JS.
- âœ… BOLEH pakai Google Fonts via `<link>`.
- âœ… BOLEH pakai `<dialog>` untuk lightbox/modal.
- âœ… BOLEH pakai CSS Grid, Flexbox, container queries, `:has()`, `clamp()`.
...
- Berikan instruksi setup GitHub Pages (Settings â†’ Pages â†’ Source: GitHub Actions) di README.
...
4. Agent akan mulai dari struktur folder â†’ tokens â†’ halaman. Konfirmasi setiap tahap.
5. Setelah selesai, **aktifkan GitHub Pages**: repo â†’ Settings â†’ Pages â†’ Source: **GitHub Actions**.
6. Push ke `main`, tunggu ~1 menit, web live di `https://username.github.io/nama-repo/`.

## ðŸ’¡ Tips Vibecoding

- **Ganti contoh warna di tokens.css** dulu sesuai brand event kamu sebelum agent generate halaman lain â€” supaya konsisten dari awal.
